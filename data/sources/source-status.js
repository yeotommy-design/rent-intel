window.RENTINTEL_SOURCE_STATUS = {
  "version": "source-status-2026-08-01",
  ...
  "status": [
    ...
    },
    {
      ...
      "currentState": "live-api-ready-token-required",
      "prototypeState": "Live lookup is implemented with a static address and map fallback",
      "productionNextStep": "Set ONEMAP_API_EMAIL and ONEMAP_API_PASSWORD in Vercel to enable automatic token renewal and live search.",
      "refreshTarget": "On search with nightly cache",
      "visibleTo": "Free and members",
      "lastCompletedAt": null,
      "timestampLabel": "Live API ready; credentials required",
      "weeklyReviewStep": "Monday review: test one token-authenticated address lookup and confirm the 24-hour cache and static fallback are healthy."
    },
    {
